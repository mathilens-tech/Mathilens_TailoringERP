...
--     -d mathilens_radhafabric_prod \
--     --file-path scripts/database/grant-app-role-ownership-radhafabric.sql
--
...
ALTER DATABASE mathilens_radhafabric_prod OWNER TO mathilens_ecommerce_app;
